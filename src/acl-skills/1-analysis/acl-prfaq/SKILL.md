...
**Graceful redirect:** If after 2-3 exchanges the user can't articulate a customer or problem, don't force it. Point them upstream: `acl-brainstorming` if they need to generate options, or `acl-forge-idea` if they hold an idea that hasn't been pressure-tested into something sound yet.
