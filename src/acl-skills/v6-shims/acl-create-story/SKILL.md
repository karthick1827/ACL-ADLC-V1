---
name: acl-create-story
description: "Deprecated: `acl-quick-dev` is now the official implementation method. Only use this when explicitly invoked by name."
---
...
<output>Deprecated: `acl-quick-dev` is now the official implementation method. Only use this when explicitly invoked by name.</output>
...
<step n="6" goal="Update sprint status and finalize">
  ...
  <output>**🎯 ULTIMATE ACL Method STORY CONTEXT CREATED, {user_name}!**
    ...
    **Next Steps:**
    ...
    4. Optional: If Test Architect module installed, run `/acl:tea:automate` after `dev-story` to generate guardrail tests

    **The developer now has everything needed for flawless implementation!**
  </output>
  <action>Run: `python3 {project-root}/_acl/scripts/resolve_customization.py --skill {skill-root} --key workflow.on_complete` — if the resolved value is non-empty, follow it as the final terminal instruction before exiting.</action>
</step>
